...
urlpatterns = [
    ...
    path('aplicar-preco/<int:pk>/<int:sugestao_id>/', views.aplicar_preco_view, name='aplicar_preco'),
    ...
    path('grupos/<int:pk>/membros/adicionar/', views.adicionar_membro_view, name='adicionar_membro'),
    path('grupos/entrar/', views.entrar_com_codigo_view, name='entrar_com_codigo'),
    ...
    path('usuario/<int:pk>/foto/', views.servir_foto_usuario_view, name='servir_foto_usuario'),
]
